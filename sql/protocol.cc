...
public:
  ...
  bool append_format_name(const LEX_CSTRING &str)
  {
    return append_chunk(MARIADB_FIELD_ATTR_FORMAT_NAME, str);
  }
  bool append_data_type_name(const LEX_CSTRING &str)
  {
    return append_chunk(MARIADB_FIELD_ATTR_DATA_TYPE_NAME, str);
  }
